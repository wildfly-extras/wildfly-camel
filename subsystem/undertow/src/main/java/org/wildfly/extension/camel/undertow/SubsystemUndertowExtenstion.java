...
public class SubsystemUndertowExtenstion implements CamelSubsytemExtension {

    @Override
    public void addService(ServiceTarget serviceTarget, SubsystemRuntimeState runtimeState) {
