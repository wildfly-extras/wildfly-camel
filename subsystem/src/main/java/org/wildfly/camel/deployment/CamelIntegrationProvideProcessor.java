 ...
 * @since 14-Jun-2013
 */
public class CamelIntegrationProvideProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(final DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        phaseContext.addDeploymentDependency(CamelConstants.CAMEL_COMPONENT_REGISTRY_NAME, CamelConstants.CAMEL_COMPONENT_REGISTRY_KEY);
    }
