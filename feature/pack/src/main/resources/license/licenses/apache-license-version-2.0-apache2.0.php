...
<div class="form-actions form-wrapper" id="edit-actions"><input value="" type="submit" id="edit-submit" name="op" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-IX3vnVIpopUq9OSSNfHr7ZTA4ENxN6Ykh2NEiMtdhxE" />
...
<div id="page" class="clearfix">
  ...
  <div class="content">
    <div class="field field-name-body field-type-text-with-summary field-label-hidden"><div class="field-items"><div class="field-item even"><p style="font-weight:bold">SPDX short identifier: Apache-2.0</p>

<div align="right">
<button onclick="myFunction()">Further resources on the <b>Apache License 2.0</b></button>
