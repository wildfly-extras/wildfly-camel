...
The RouteBuilder implementation is different to the previous examples. Instead of injecting the connection factory, we need to configure an InitialContext and retrieve it from JNDI ourselves.
