...
3. a deployment that contains a type annotated with `@ImportResource`
4. a deployment that annotates a `RouteBuilder`, `CamelContext` or other Camel API with any combination of `@ApplicationScoped`, `@Inject`, `@Named` or `@Produces`
