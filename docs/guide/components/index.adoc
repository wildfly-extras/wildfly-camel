...
To make this module visible by default to arbitrary Jarkarta EE deployments add a reference to `modules/system/layers/fuse/org/apache/camel/component/main/module.xml`
