package org.wildfly.camel.test.domain;
/*
...
public class DomainTestSuite {
    ...
    private synchronized static void start(final String name) {
        try {
            Configuration configuration = DomainTestSupport.Configuration.create(name,
                    "domain-configs/domain-camel.xml", "host-configs/host-master.xml", "host-configs/host-slave.xml");
            support = DomainTestSupport.createAndStartSupport(configuration);
        } catch (Exception e) {
