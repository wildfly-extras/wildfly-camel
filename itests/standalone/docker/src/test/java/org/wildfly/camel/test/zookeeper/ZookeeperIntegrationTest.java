...
public class ZookeeperIntegrationTest {
    ...
    public static JavaArchive deployment() {
        ...
        archive.addClasses(CuratorFactoryBean.class, TestUtils.class);
        return archive;
    }
        ...
        public void setup(ManagementClient managementClient, String someId) throws Exception {
            ...
            */
            ...
            if (!dockerManager
                ...
                throw new IllegalStateException("Zookeeper server could not be started in time");
            }
        }
    ...
    public void testCurator() throws Exception {
        ...
        CuratorFactoryBean factory = new CuratorFactoryBean();
        factory.setConnectString(getZookeeperConnection());
        
        CuratorFramework curator = factory.getObject();
        Assert.assertEquals(CuratorFrameworkState.STARTED, curator.getState());
    }

    @Test
    public void testZookeeperMaster() throws Exception {
        ...
        try (CamelContext camelctx = new DefaultCamelContext()) {
            ...
            camelctx.addRoutes(new RouteBuilder() {
                @Override
                public void configure() throws Exception {
                    from("zookeeper-master:master-000:quartz://masterTest?trigger.repeatCount=300&trigger.repeatInterval=100")
                        .to("mock:results");
                }
            });
