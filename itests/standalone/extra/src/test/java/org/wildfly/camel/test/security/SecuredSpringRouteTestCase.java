...
public class SecuredSpringRouteTestCase {
    ...
    public static JavaArchive createDeployment() {
        JavaArchive archive = ShrinkWrap.create(JavaArchive.class, "secured-spring-route-test");
        archive.addAsResource("security/secured-route-camel-context.xml");
        return archive;
    }
