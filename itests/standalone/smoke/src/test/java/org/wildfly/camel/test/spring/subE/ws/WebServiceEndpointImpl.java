 ...
 * #L%
 */
package org.wildfly.camel.test.spring.subE.ws;
...
@WebService(targetNamespace = "http://wildfly.camel.test.ws", endpointInterface = "org.wildfly.camel.test.spring.subE.ws.WebServiceEndpoint")
public class WebServiceEndpointImpl {
